package com.xujiangjun.example.biz.util;
...
public class MailUtils {
    ...
    public static void sendActivateMail(String toUser, String code){
        String subject = "来自Example网站的激活邮件";
        String content = "<h1>来自Example网站的激活邮件, 激活请点击以下链接：</h1>" +
                "<h3><a href='http://localhost:8080/example/active?code=" + code + "'>" +
                "http://localhost:8080/example/active?code=" + code + "</a></h3>";
